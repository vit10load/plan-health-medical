...
<div class="form-group">
  ...
  <table class="table table-bordered table-striped">
    ...
    <thead>
      <tr>
        <th colspan="3"><h4 class="text-center">Plan Details</h3></th>
        </tr>
      </thead>
      <tbody>
       ...
       if (isset($plans)) {
        ...
        foreach ($plans as $key) { ?>
         ...
         <tr>
          ...
          <td colspan="3"><?php echo $key->acomodacao; ?></td>
        </tr>
        <tr>
          <td>Plan Segmentation</td>
          <td colspan="3"><?php echo $key->segmentacao; ?></td>
        </tr>
        <tr>
          <td>Refund</td>
          <td colspan="3"><?php echo $key->reembolso; ?></td>
        </tr>
        <tr>
          <td>Medical Network</td>
          <td colspan="3"><?php echo $key->rede_medica; ?></td>
        </tr>
         <tr>
          <td>User bind to</td>
          <td colspan="3"><?php echo $key->user_name; ?></td>
        </tr>
        <tr> 
          <td>
          ...
          <td>
            <form action="<?php echo base_url('plan/bind_plan_by_user_id'); ?>" method="POST">
              <div class="form-group">
                <select class="form-control" name="user_id">
                  <option value="">Click to view users</option>
                  <?php 
